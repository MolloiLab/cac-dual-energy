...
root = datadir("dcms_calibration_low_density", "$(SIZE)")
...
calcium_densities = [0, 10, 16, 25, 45, 50, 75, 100, 200, 300, 400, 500, 600, 800]
...
save(datadir("calibration_params_low_density",file_name),df_params)
