...
# ╔═╡ 6e9f90e8-dee9-4e23-9912-a64f7fe93c19
numbers = ["_1","_2","_3"];
    ...
    for energy in energies
        for _size in sizes
            for density in densities
				...
				path_root = datadir("mat_calibration_low_density",_size[1],string(density))
				
				
				path = string(path_root, "rod",energy,"kV",_size[2],num,".mat")
                vars1 = matread(path)
